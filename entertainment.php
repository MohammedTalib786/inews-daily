...
<head>
    ...
    <title>Entertainment | iNews App</title>
...
<body>
    ...
    if (isset($_SESSION["email"]) && isset($_SESSION["username"])) {
        ...
        echo "
        <h1 class='text-center my-5 '>iNews Daily - Entertainment</h1>
    ...
    <script>
        const fetchDataEntertainment = (async () => {
            try {
                ...
                let result = response.Entertainment;
